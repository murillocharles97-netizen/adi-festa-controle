...
test("toda a cadeia de módulos da sincronização invalida o cache na release 102", () => {
  ...
  assert.match(serviceWorkerSource, /adi-festa-v102-mercadopago-pix-subscriptions/);
  assert.doesNotMatch(
    `${authSource}\n${firebaseUiSource}\n${syncSource}`,
