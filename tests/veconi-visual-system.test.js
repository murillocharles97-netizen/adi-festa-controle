...
test('service worker v126 troca o cache e inclui os assets da nova marca', () => {
  const worker = read('service-worker.js');
  assert.match(worker, /veconi-v126-financial-ui-tools/);
  assert.match(worker, /release:'126'/);
