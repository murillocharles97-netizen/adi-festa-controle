...
test('service worker v127 troca o cache e inclui os assets da nova marca', () => {
  const worker = read('service-worker.js');
  assert.match(worker, /veconi-v127-credit-card-bill-payment/);
  assert.match(worker, /release:'127'/);
