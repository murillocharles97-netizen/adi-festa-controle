...
test('service worker v125 troca o cache e inclui os assets da nova marca', () => {
  const worker = read('service-worker.js');
  assert.match(worker, /veconi-v125-finance-loading-fix/);
  assert.match(worker, /release:'125'/);
