...
test('service worker v131 troca o cache e inclui os assets da nova marca e do Financeiro', () => {
  const worker = read('service-worker.js');
  assert.match(worker, /veconi-v131-financial-account-deduplication/);
