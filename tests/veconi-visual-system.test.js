...
test('service worker v124 troca o cache e inclui os assets da nova marca', () => {
  const worker = read('service-worker.js');
  assert.match(worker, /veconi-v124-shared-credit-cards/);
  assert.match(worker, /release:'124'/);
