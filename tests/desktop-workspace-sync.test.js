...
test("publica os arquivos desktop e o identificador do build em cache novo", () => {
  ...
  assert.match(index, /app\.js\?v=115/);
  assert.match(index, /build-info\.js\?v=118/);
  ...
  assert.match(worker, /release:'118'/);
  assert.match(build, /release: "118"/);
  assert.match(index, /firebase-ui\.js\?v=108/);
