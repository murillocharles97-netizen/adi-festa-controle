...
const onboardingService=read('functions/src/services/onboarding-service.js');
assert.match(onboardingService,/planId:'trial',status:'trial'/);
assert.match(onboardingService,/membershipId=`\$\{businessId\}_\$\{authUid\}`/);
