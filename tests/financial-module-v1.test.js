...
test("Financeiro está no router, shell e usa um único renderer responsivo", () => {
  ...
  assert.ok(html.indexOf("financial-space-service.js?v=128") < html.indexOf("auth.js?v=123"));
...
test("release 128 publica o refinamento financeiro no novo cache VECONI", () => {
  assert.match(read("js/build-info.js"), /release: "128"/);
  assert.match(sw, /veconi-v128-financial-refinement/);
