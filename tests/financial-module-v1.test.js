...
test("Financeiro está no router, shell e usa um único renderer responsivo", () => {
  ...
  assert.ok(html.indexOf("financial-space-service.js?v=129") < html.indexOf("auth.js?v=123"));
...
test("release 129 publica a Home financeira consolidada no novo cache VECONI", () => {
  assert.match(read("js/build-info.js"), /release: "129"/);
  assert.match(sw, /veconi-v129-financial-consolidated-home/);
