...
assert.match(source,/persistent\s*:\s*true/);
...
assert.match(source,/label\s*:\s*["']Escanear["']\s*,\s*action\s*:\s*["']scan-sale["']/);
assert.match(source,/label\s*:\s*["']Ler código["']\s*,\s*action\s*:\s*["']scan-product["']/);
