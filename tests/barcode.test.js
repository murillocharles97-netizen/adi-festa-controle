...
assert.match(worker,/adi-festa-v52-subscriptions-backend/);
...
assert.match(clientsMobile,/!\['vender','produtos'\]\.includes/,'client creation must not intercept scanner FAB routes');
