...
async function main(){
  ...
  try{
    ...
    assert.ok(reconciliation.checked>=1);assert.equal(beatriz.amountCents,6350);assert.equal(beatriz.paymentMethod,'pix');assert.equal(beatriz.autoGenerated,true);
