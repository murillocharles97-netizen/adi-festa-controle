(function(){
  ...
  function bindPage(page){
    ...
    page.addEventListener('keydown',event=>{const favorite=event.target.closest('[data-fav]');if(favorite&&['Enter',' '].includes(event.key)){event.preventDefault();favorite.click()}});
