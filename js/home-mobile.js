(function(){
  ...
  function render(){
    ...
    return`<section class="mobile-home-dashboard"><div class="home-greeting"><h2>${icon('hand')} ${greeting()}, ${esc(data.name)}!</h2><p>${esc(smartMessage(data))}</p></div>${goalCard(data)}${main}${secondary}${attention}${chart(data)}${quick}</section>`
  }
  function goalModal(){
